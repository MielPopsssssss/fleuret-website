      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-destructive/20 bg-destructive/5 backdrop-blur-sm mb-4">
          ...
          <Card className="p-8 md:p-12 border-destructive/30 bg-gradient-to-br from-card/80 to-card/50 backdrop-blur-sm">
            ...
            <div className="mt-8 pt-8 border-t border-primary/10 text-center">
              <p className="text-lg text-muted-foreground">
                Pendant ce temps, vos systèmes restent <span className="text-destructive font-semibold">exposés aux cyberattaques</span>
              </p>
            </div>
          </Card>
        </div>
