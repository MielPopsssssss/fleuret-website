...
const translations = {
  fr: {
    ...
    'waitlist.email.placeholder': 'Entrez votre email',
    'waitlist.submit': 'Devenir Early Adopter',
    'waitlist.submitting': 'Envoi...',
    'waitlist.success': 'Merci ! Vous recevrez un email de confirmation.',
  ...
  en: {
    ...
    'waitlist.email.placeholder': 'Enter your email',
    'waitlist.submit': 'Become an Early Adopter',
    'waitlist.submitting': 'Sending...',
    'waitlist.success': 'Thank you! You will receive a confirmation email.',
