...
const translations = {
  fr: {
    ...
    'waitlist.subtext': 'Accédez en avant-première à notre solution de pentest IA. Pas de spam, jamais.',
  ...
  en: {
    ...
    'waitlist.subtext': 'Get early access to AI search analytics. No spam, ever.',
